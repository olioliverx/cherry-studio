export const paintingClasses = {
  ...
  historyStrip:
    'shell-launcher-clearance flex h-full w-[68px] shrink-0 flex-col gap-2 overflow-y-auto bg-background px-2 pt-3 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden',
  historyAddButton:
