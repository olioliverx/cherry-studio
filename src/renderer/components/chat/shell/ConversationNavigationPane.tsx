...
export function ConversationNavigationPane({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      className={cn(
        'conversation-navigation-pane relative flex w-[var(--assistants-width)] flex-col overflow-hidden border-sidebar-border border-r bg-sidebar transition-[width] duration-300',
