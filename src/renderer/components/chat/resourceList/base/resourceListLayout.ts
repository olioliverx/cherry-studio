...
export const RESOURCE_LIST_VISUAL_ROW_CLASS = 'h-8 rounded-md'
...
export const RESOURCE_LIST_ITEM_LEADING_SLOT_CLASS =
  'rounded-md text-muted-foreground group-hover:text-foreground group-focus-visible:text-foreground group-data-[selected=true]:text-foreground [&_svg]:size-4 [&_svg]:shrink-0'

export const RESOURCE_LIST_GROUP_HEADER_LEADING_SLOT_CLASS =
  'rounded-md text-inherit [&_svg]:size-4 [&_svg]:text-inherit'

export const RESOURCE_LIST_LEADING_ACTION_SLOT_CLASS = RESOURCE_LIST_LEADING_SLOT_BASE_CLASS

export const RESOURCE_LIST_SELECTED_ROW_CLASS = 'bg-sidebar-accent/70 text-sidebar-foreground shadow-none'
